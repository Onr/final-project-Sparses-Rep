...
% for ii = 1:m
%     randSizeX = randi(16)+4;
%     randSizeY = randi(16)+4;
%     randPosX = randi(40-randSizeX+1);
%     randPosY = randi(40-randSizeY+1);
%     randSign = randi(2)*2-3;
%     Atom = zeros(sqrt(n));
%     Atom(randPosY:randPosY+randSizeY-1,randPosX:randPosX+randSizeX-1)=randSign;
%     
%     A(:,ii) = Atom(:);
%     A_normalized = A ./ sqrt(sum(A.*A, 1));
% 
% end
...
for experiment = 1:num_experiments
 ...
 %%%%%%%%   do I need it ????????A_eff( :, ~any(A_eff,1) ) = [];
    ...
    %%%%%%% acording to the instrution the true support is known %%%%%%%%%%%%
    A_eff_on_true_supp = A_eff(:,find(x0));
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% x_oracle =  pinv(A_eff)*b ;
    x_oracle  = zeros(m,1);
    x_oracle(find(x0)) =  pinv(A_eff_on_true_supp)*b ;
...
% % %%%%%%%%%%%%%%%%%%% show result o.n %%%%%%%%%%%%%%%%%%%%%
% % figure
% % imshow(reshape(b0,n,n),[]);
% % title('b0');
% % figure
% % imshow(reshape(b0_noisy,n,n),[]);
% % title('b0_noisy');
% % figure
% % imshow(reshape(C'*b,n,n),[]);
% % title('b');
% % figure
% % imshow(reshape(b_oracle,n,n),[]);
% % title('b_oracle');
% % 
% % %%%%%%%%%%%%%%%%%%% show result o.n %%%%%%%%%%%%%%%%%%%%%
% % %%%%%%%%%%%%%%%%%%% show result o.n %%%%%%%%%%%%%%%%%%%%%  
...
% % title('b');
% % figure
% % imshow(reshape(best_b_admm,n,n),[]);
% % title('b BP admm');
% % %%%%%%%%%%%%%%%%%%% show result o.n %%%%%%%%%%%%%%%%%%%%%
% % %%%%%%%%%%%%%%%%%%% show result o.n %%%%%%%%%%%%%%%%%%%%%   
